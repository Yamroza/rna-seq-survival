...
# KLUCZOWE: src jako root dla "model"
SRC_DIR = os.path.join(BASE_DIR, "ts_survival_prediction", "src")
sys.path.insert(0, SRC_DIR)

ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))

# tsa_root = os.path.abspath("..")  # folder zawierający ts_survival_prediction
...
for fold in range(5):
    ...
    args = Namespace(
        ...
        data_type="csv",
        expression_data_path="/scratch/2370352/my-research/data/0_data_for_mlp",
        folds=fold,
    ...
    explainer = shap.DeepExplainer(model, background_data_new_tensor)
    print("Done")

    shap_values = explainer.shap_values(train_data_new_tensor)
    ...
    save_genes(importance_df, 6000, f'fold_{fold}_lasso', 'training_shap.jsonl')
